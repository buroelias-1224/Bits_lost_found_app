...
class LostItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lost_item" do
    assert_difference("LostItem.count") do
      post lost_items_url, params: { lost_item: { description: @lost_item.description, location: @lost_item.location, status: @lost_item.status, title: @lost_item.title, user_id: @lost_item.user_id } }
    end
  ...
  test "should update lost_item" do
    patch lost_item_url(@lost_item), params: { lost_item: { description: @lost_item.description, location: @lost_item.location, status: @lost_item.status, title: @lost_item.title, user_id: @lost_item.user_id } }
